...
enum opt_code
{
  ...
  OPT_mtrack_speculation = 1210,             /* -mtrack-speculation */
  ...
  OPT_nostartfiles = 1219,                   /* -nostartfiles */
  OPT_nostdinc = 1220,                       /* -nostdinc */
  OPT_nostdinc__ = 1221,                     /* -nostdinc++ */
  OPT_nostdlib = 1222,                       /* -nostdlib */
  OPT_o = 1223,                              /* -o */
  OPT_p = 1224,                              /* -p */
  OPT_pass_exit_codes = 1225,                /* -pass-exit-codes */
  /* OPT_pedantic = 1226, */                 /* -pedantic */
  OPT_pedantic_errors = 1227,                /* -pedantic-errors */
  OPT_pg = 1228,                             /* -pg */
  OPT_pie = 1229,                            /* -pie */
  OPT_pipe = 1230,                           /* -pipe */
  OPT_print_file_name_ = 1231,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1232,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1233,          /* -print-multi-directory */
  OPT_print_multi_lib = 1234,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1235,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1236,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1237,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1238,               /* -print-prog-name= */
  OPT_print_search_dirs = 1239,              /* -print-search-dirs */
  OPT_print_sysroot = 1240,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1241,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1242,                          /* -quiet */
  OPT_r = 1243,                              /* -r */
  OPT_remap = 1244,                          /* -remap */
  OPT_s = 1245,                              /* -s */
  ...
  OPT_static_libgfortran = 1255,             /* -static-libgfortran */
  OPT_static_libgo = 1256,                   /* -static-libgo */
  OPT_static_liblsan = 1257,                 /* -static-liblsan */
  OPT_static_libmpx = 1258,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1259,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1260,               /* -static-libstdc++ */
  OPT_static_libtsan = 1261,                 /* -static-libtsan */
  OPT_static_libubsan = 1262,                /* -static-libubsan */
  OPT_static_pie = 1263,                     /* -static-pie */
  ...
  OPT_std_c__2a = 1271,                      /* -std=c++2a */
  OPT_std_c__98 = 1272,                      /* -std=c++98 */
  OPT_std_c11 = 1273,                        /* -std=c11 */
  OPT_std_c17 = 1274,                        /* -std=c17 */
  /* OPT_std_c18 = 1275, */                  /* -std=c18 */
  /* OPT_std_c1x = 1276, */                  /* -std=c1x */
  /* OPT_std_c89 = 1277, */                  /* -std=c89 */
  OPT_std_c90 = 1278,                        /* -std=c90 */
  OPT_std_c99 = 1279,                        /* -std=c99 */
  /* OPT_std_c9x = 1280, */                  /* -std=c9x */
  OPT_std_f2003 = 1281,                      /* -std=f2003 */
  OPT_std_f2008 = 1282,                      /* -std=f2008 */
  OPT_std_f2008ts = 1283,                    /* -std=f2008ts */
  OPT_std_f2018 = 1284,                      /* -std=f2018 */
  OPT_std_f95 = 1285,                        /* -std=f95 */
  OPT_std_gnu = 1286,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1287, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1288, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1289,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1290,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1291,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1292, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1293, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1294,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1295,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1296,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1297,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1298, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1299, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1300, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1301,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1302,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1303, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1304, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1305,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1306, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1307, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1308, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1309, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1310, */         /* -std=iso9899:2018 */
